...
data_in = "/Users/ilias/OneDrive/Documenten/GitHub/irisnevel/data/processed/ngc7023 r filter goed.fit"
...
error = (np.sqrt((phot_table['aperture_sum'] - total_bkg) + aperture.area * (bkg_mean + 4.2 + 100))) / total_bkg
print(error)